...
def build_model(drop=0.5, optimizer='adam',activation1 = 'relu',activation2 = 'relu',activation3 = 'relu',a = 32,b=32,c=32):
    ...
    x = Dropout(drop)(x)
    outputs = Dense(2,activation='sigmoid',name='ouputs')(x)
...
# {'optimizer': 'adam', 'drop': 0.3, 'c': 16, 'batch_size': 64, 'b': 128, 'activation3': 'sigmoid', 'activation2': 'tanh', 'activation1': 'relu', 'a': 64}
# <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x0000027AF43C7F70>
# 0.9802341063817342
# 2/2 [==============================] - 0s 499us/step - loss: 0.0582 - acc: 0.9825
