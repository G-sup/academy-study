...
modelpath = '../Data/modelCheckPoint/k62_iris_{epoch:02d}-{val_loss:.4f}.hdf5' 
...
# {'optimizer': 'adam', 'drop': 0.1, 'c': 32, 'batch_size': 64, 'b': 256, 'activation3': 'sigmoid', 'activation2': 'relu', 'activation1': 'relu', 'a': 256}
# <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x000001D1986584C0>
# 0.9583333532015482
# 1/1 [==============================] - 0s 0s/step - loss: 0.0903 - acc: 0.9667
