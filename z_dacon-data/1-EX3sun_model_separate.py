...
df2 = pd.read_csv('./z_dacon-data/test/1.csv', index_col=[0,1,2], header=0) 
...
for q in qunatile_list:
    ...
    rl=ReduceLROnPlateau(monitor='val_loss', mode='auto', patience=10, factor=0.5)
    ...
    file_path='./z_dacon-data/test_test/quantile_1_loss_' + str(q) + '.csv'
