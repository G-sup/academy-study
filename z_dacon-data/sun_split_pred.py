...
x = x.reshape(-1, 5, 7)
x_train = x_train.reshape(-1, 5, 7)
x_test = x_test.reshape(-1, 5, 7)
x_val = x_val.reshape(-1, 5, 7)
x_pred = x_pred.reshape(-1, 5 ,7)
...
# 2
model = Sequential()
model.add(GRU(256,activation='relu', input_shape = (5,7), return_sequences=True))
