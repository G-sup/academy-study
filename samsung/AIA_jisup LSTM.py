...
#2
model= Sequential()
model.add(LSTM(512,activation='relu',input_shape=(6,1)))
...
#3
modelpath = '../data/modelCheckPoint/samsung_test_LSTM_{epoch:02d}-{val_loss:.7f}.hdf5'
