...
df1 = pd.read_csv('../study/samsung/samsung3.csv',encoding='cp949',thousands = ',', index_col=0, header=0) 
...
np.save('./samsung/e-s3.npy',arr=([x,y,x_pred,x_train,x_test,x_val,y_train,y_test,y_val]))
'''
...
model.fit(x_train,y_train,epochs=1,batch_size=8,validation_data=(x_val,y_val),verbose=1,callbacks=[early_stopping,mc])
