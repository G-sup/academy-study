...
submission = pd.read_csv('C:/data/dacon/dacon3/mnist_data/submission.csv')
...
img_fit = model.fit(x_train,y_train,batch_size=32,epochs=epochs,validation_data=(x_test,y_test), callbacks=[ea,mc,re])
...
df = pd.DataFrame(result, columns='letter') 



df.to_csv('C:/data/dacon/dacon3/mnist_data//Dacon_3.csv', sep=',') 
