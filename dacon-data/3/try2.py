...
model = Sequential()
model.add(Conv2D(32,kernel_size=(3,3), input_shape=(120,120,1), strides=1,padding='same', activation='relu'))
...
model.add(Conv2D(128, (3,3), strides=2,activation='tanh'))
...
model.fit(x_train,y_train,verbose=1,batch_size=64,epochs=1 ,validation_split= 0.2, callbacks=[es,lr])
