...
dirty_mnist_answer = pd.read_csv("C:/data/dacon/dacon3/dirty_mnist_2nd_answer.csv")
# dirty_mnist라는 디렉터리 속에 들어있는 파일들의 이름을 
# namelist라는 변수에 저장
namelist = os.listdir('C:/data/dacon/dacon3/dirty_mnist_2nd/')
...
if __name__ == '__main__':
    ...
    for fold_index, (trn_idx, val_idx) in enumerate(kfold.split(dirty_mnist_answer),1):
        ...
        #Dataset 정의
        train_dataset = DatasetMNIST("C:/data/dacon/dacon3/dirty_mnist_2nd/", train_answer)
        valid_dataset = DatasetMNIST("C:/data/dacon/dacon3/dirty_mnist_2nd/", test_answer)
    ...
    test_dataset = DatasetMNIST("C:/data/dacon/dacon3/test_dirty_mnist_2nd", sample_submission)
    batch_size = 128
    ...
    predictions_list = []
    # 배치 단위로 추론
    prediction_df = pd.read_csv("C:/data/dacon/dacon3/sample_submission.csv")
    ...
    sample_submission.to_csv("C:/data/dacon/dacon3/baseline_prediction.csv", index = False)
    sample_submission