...
#2
model = Sequential()
model.add(GRU(128, activation='relu',input_shape=(13,1)))
model.add(Dense(128))
model.add(Dense(128))
model.add(Dense(128))
model.add(Dense(128))
...
model.fit(x_train, y_train,epochs=300,batch_size=2,validation_data=(x_val,y_val),verbose=1,callbacks=[early_stopping])
