...
#1이 넘는 경우 ValueError: The sum of test_size and train_size = 1.1, should be in the (0, 1) range. Reduce test_size and/or train_size.
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.7, test_size=0.2, shuffle=False)
#1이 안되는 경우는 뒤에서 부터 잘린다 즉 앞에서 부터 순차적으로. train값이 우선권을 갖는다
