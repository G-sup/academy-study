...
from tensorflow.keras.layers import Dense , Conv1D , Flatten ,MaxPool1D, LSTM, GRU, Dropout,Reshape
...
#2
model = Sequential()
model.add(Dense(10, activation='relu', input_shape=(32, 32, 3)))
model.add(Dropout(0.3))
model.add(Dense(10))
model.add(Dense(10,activation='relu'))
model.add(Dense(1024,activation='relu')) # Reshape전에 노드의 개수를 바꿔준다
