...
np.save('../data/npy/fmnist_x_train.npy',arr=fm_x_train)
np.save('../data/npy/fmnist_x_test.npy',arr=fm_x_test)
np.save('../data/npy/fmnist_y_train.npy',arr=fm_y_train)
np.save('../data/npy/fmnist_y_test.npy',arr=fm_y_test)
