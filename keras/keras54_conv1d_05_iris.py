...
from tensorflow.keras.layers import Dense, Input, LSTM,Conv1D,MaxPool1D,Flatten,Dropout
...
#2 모델 구성
model = Sequential()
model.add(Conv1D(356,3,activation='relu', input_shape=(4,1)))
...
# 
# [0.04873030632734299, 0.9666666388511658]
# [0 0 0 1 2 2 1 2 1 0 0 1 1 2 1 0 1 1 2 0 1 0 2 0 2 1 0 0 0 1]
# [0 0 0 1 2 1 1 2 1 0 0 1 1 2 1 0 1 1 2 0 1 0 2 0 2 1 0 0 0 1]