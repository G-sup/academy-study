...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
      ...
      # tf.keras.layers.Conv1D(128,2,input_shape = [None,1]),
      tf.keras.layers.Conv1DTranspose(128,4,input_shape = [None,1]),
    ...
    model.fit(train_set, epochs = 1000,validation_data = validation_set,verbose = 1, callbacks= [es,lr])
