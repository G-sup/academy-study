...
# # x_train = image_generator.flow_from_directory('C:/Users/Admin/Desktop/anime',seed=104,target_size=(128, 128),batch_size=50000,color_mode='grayscale')#,subset="training")
# x_train = image_generator.flow_from_directory('C:/Users/Admin/Desktop/anime/archive',seed=104,target_size=(128, 128),batch_size=100000,color_mode='grayscale')#,subset="training")

# np.save('C:/Users/Admin/Desktop/project.npy', arr=x_train[0][0])
...
def train(iterations, batch_size, sample_interval):
    ...
    # MNIST 데이터셋 로드
    x_train = np.load('C:/Users/Admin/Desktop/project.npy')
