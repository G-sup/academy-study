...
x = layers.Conv2D(32, 4)(discriminator_input)
x = layers.LeakyReLU()(x)
...
x = layers.LeakyReLU()(x)
x = layers.Conv2D(1024, 4, strides=2)(x)
x = layers.LeakyReLU()(x)
x = layers.Flatten()(x)
...
discriminator_optimizer = keras.optimizers.Adam(lr=0.002, beta_1=0.5)
...
for step in range(iterations):
    ...
    if step % 100 == 0:
        ...
        gan.save_weights('ganc_ac128_adam.h5')
        ...
        img.save(os.path.join(save_dir, 'generated_ac128_' + str(step) + '.png'))
