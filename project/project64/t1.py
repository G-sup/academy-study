...
x_train = image_generator.flow_from_directory('C:/Users/Admin/Desktop/anime/test',seed=104,target_size=(64, 64),batch_size=50000)#,subset="training")

np.save('C:/Users/Admin/Desktop/project_c2.npy', arr=x_train[0][0])
...
def train(iterations, batch_size, sample_interval):
    ...
    # MNIST 데이터셋 로드
    x_train = np.load('C:/Users/Admin/Desktop/project_c.npy')
...
def sample_images(generator, image_grid_rows=4, image_grid_columns=4):
    ...
    for i in range(image_grid_rows):
        for j in range(image_grid_columns):
            ...
            axs[i, j].axis('off')
            cnt += 1
            fig.savefig("C:/Users/Admin/Desktop/anime/ganimages/gan_mnist_%d.png"%i)
    plt.show()
